...
(function () {
    ...
    GoogleClosureProcessor.prototype.processComment = function (comment) {
        ...
        if (comment.ctx) {
            ...
            comment.tags = comment.tags.map(function (tag) {
                ...
                switch (tag.type) {
                    ...
                    case "constructor":
                        ...
                        // Remember constructor name for "@member"
                        instance._currentConstructor = comment.ctx.name;
                        break;

                    case "member":
                        comment.ctx.scope.owner = instance._currentConstructor;
                        comment.modifiers = [];
            ...
            comment.memberTypes = memberTypes;
